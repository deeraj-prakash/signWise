...
export default function  BlogPostsSearch({ sx,tit,titt}) {
    ...
    >
      <Autocomplete
        ...
        renderInput={(params) => (
          <TextField
            {...params}
            placeholder={tit === 'All Clients'? 'Search Clients...': tit === 'All Team Members' ? 'Search Team Members...' : "Search Projects..."}
            InputProps={{
              ...params.InputProps,
              startAdornment: (
                <>
