...
export default function AddProject ({add,setAdd, currentUser}){
...
const LabelStyle = styled(Typography)(({ theme }) => ({
  ...
  const formik = useFormik({
    ...
    initialValues: {
       ...
       sh_name:  '1500.00',
       Type: '1000.00',
       Category: 'Double Face Post mounted Sign',
    //   country: currentUser?.country || '',
    //   state: currentUser?.state || '',
    //   city: currentUser?.city || '',
    //   zipCode: currentUser?.zipCode || '',
      avatarUrl: 'https://signwisesolutions.com/uploads/products/IMG_0172.JPG',
  ...
  return (
    <Page title="Edit Products | Sign-Wise Solution">
      <Container>
