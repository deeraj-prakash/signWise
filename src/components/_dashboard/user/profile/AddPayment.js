...
import SelectRequest from 'src/components/_dashboard/user/SelectRequest.js';
...
const LabelStyle = styled(Typography)(({ theme }) => ({
  ...
  return (
    <Page title="Generate Invoice | Sign-Wise Solution">
      <Container>
              ...
              <Stack spacing={3}>
                <Stack direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 3, sm: 2 }}>
                  ...
                  <Autocomplete
                    ...
                    fullWidth
                    id="request-as-demo" // change the id
                    options={SelectRequest} // change the options to Inviteas
                ...
                <Box sx={{ mt: 3, display: 'flex', justifyContent: 'flex-end' }}>
                  <LoadingButton type="submit" variant="contained" component={RouterLink} to={PATH_DASHBOARD.payments.root} loading={isSubmitting}>
                    {!isEdit ? 'Generate' : 'Generate'}
                  </LoadingButton>
                  <Button variant="outlined" type="submit" component={RouterLink} to={PATH_DASHBOARD.payments.root} sx={{marginLeft: '10px'}}>
                      Cancel
                  </Button>
                </Box>
              </Stack>
