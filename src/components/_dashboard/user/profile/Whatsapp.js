...
export default function Messages({ post }) {
  // const { user } = useAuth();
          ...
          >
            ...
            <Paper
              sx={{
                ...
                bgcolor: index % 2 === 0 ? '#DCF8C6' : '#E1E3E5', // Adjust colors based on the sender
                color: index % 2 === 0 ? '#000' : '#000', // Adjust the text colors as needed
                borderRadius: '12px',
              }}
            >
              <Stack
              ...
              >
                <Typography
                  variant="subtitle2"
                  sx={{ color: '#000' }} // Adjust the text color for the subtitle as needed
                >
                  {comment.author.name}
                </Typography>
                <Typography variant="caption" sx={{ color: 'text.disabled' }}>
