...
export default function EditCustomFieldsTemplate() {
    ...
    return (
        <Page title="Edit Custom Fields Template | Sign-Wise Solution">
            <Container>
                <Stack
                    direction="row"
                    alignItems="center"
                ...
                >
                    <HeaderBreadcrumbs heading="Edit Custom Fields Template" />
                </Stack>
                  ...
                  <Draggable key={data.id} draggableId={data.id.toString()} index={index}>
                    {(provided) => (
                      ...
                      >
                        ...
                        >
                          {data.icon}
                          <Typography color={theme.palette.primary.contrastText} variant="subtitle2">
                            {data.value}
                          </Typography>
                        </Stack>
                      </div>
                ...
                {provided.placeholder}
                    ...
                    >
                        ...
                        <LoadingButton
                            ...
                            variant="contained"
                            onClick={() => {
                                navigate(PATH_DASHBOARD.customfieldtemplate.create)
                            }}
