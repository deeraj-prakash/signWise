...
import  FilesToolbar  from 'src/components/_dashboard/user/list/FilesToolbar';
...
const TABLE_HEAD = [
  ...
  { id: 'amount', label: 'Uploaded On', alignRight: false },
  { id: 'paidon', label: 'Uploaded By', alignRight: false },
...
export default function Files(props) {
  ...
  const Files = onboard_data; // Replaced Files with onboard_data
  ...
  return (
    <Page title="Files | SignWise Solutions">
      <Container>
        {/* <HeaderBreadcrumbs
          heading="User List"
          links={[
        ...
        <Card>
          <FilesToolbar numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} />
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, uploadedon,uploadedby, status } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{uploadedon}</TableCell>
                        <TableCell align="left">{uploadedby}</TableCell>
