...
export default function SmsLog({ myProfile, posts }) {
  ...
  const [userList, setUserList] = useState([
    { status: 'answered', phone: '9876543210', message: '' , date: ''},
    { status: 'answered', phone: '9876543210', message: '' , date: ''},
    { status: 'missed', phone: '9876543210', message: '' , date: ''},
    { status: 'missed', phone: '9876543210', message: '' , date: ''},
  ]);
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { status, phone, message, date } = row;
